  ...
  return (
    <div className={styles.surf}>
      ...
      >
        ...
        <SubPageSubSecTitle id={0} text="プロダクト制作" />
        <SubPageSubSecTitle id={0} text="サーフィン コンサルタント" />
        <SubPageSubSecTitle id={0} text="モノ提供" />
        <SubPageSubSecTitle id={0} text="人材派遣" />
        ...
        <SubPageMainText
          id={1}
          text="Coolな若者とともにサーフィン、イベント。"
        />
        <SubPageMainText
          id={1}
          text="場所決め、工程作り、場所の許可取りや備品の手配、サーフィン保険、先方のロゴのついたグッズを身につけ、サーフィンをしたりイベントを行います。エリアやイベントの規模、参加人数は要相談。"
        />
        ...
        <SubPageMainText
          id={1}
          text="若者の感性を元に今の時代にあったプロダクトの制作を支援いたします。"
        />
        <SpaceBox id={1} level="small" />
        <SubPageSubSecTitle id={0} text="Surf Consultanting" />
        <SubPageMainText
          id={1}
          text="今の時代を生き、かつクリエイティブなサーフ系の若者の考えや目線を伝え向上と指針を示す援助をいたします。"
        />
        <SpaceBox id={1} level="small" />
      </SubChildPage>
    </div>
