...
import ContactContents from "@/components/molecules/ContactContents";
  ...
  return (
    <div className={styles.contact}>
      ...
      <SubPageHeroLayout
        ...
        desc={
          "We always have the resources to make your story come to life in the best way possible. Please feel free to contact us."
        }
      ...
      <SubPageBody id={7}>
        ...
        <SubPageMainText
          id={6}
          text="所在地:     東京都渋谷区神南1-3-4 神南ビル1階"
        />
        <SubPageMainText
          id={6}
          text="事業:     イベント業、クリエイティブ制作事業、観光業"
        />
        ...
        <SubPageMainText
          id={7}
          text="私たちは学生が集まり、共に成長し、楽しい時間を過ごすコミュニティです。お問い合わせ、ご質問、提案、または単にこんにちはと言いたい場合、以下のお問い合わせフォームをご利用ください。"
        />
        <SubPageMainText
          id={7}
          text="コンタクトフォームは企業向けと個人向けの2つがございます。お問い合わせ内容によりますが、返答にお時間をいただく場合がございます。学生たちが授業やプロジェクトに没頭している場合、少々お待ちいただくことがありますが、お手続きいただきましたら必ず対応させていただきます。"
        />
        <SubPageMainText
          id={7}
          text="何かご不明点や緊急のお問い合わせがある場合は、SNSアカウントからもお気軽にお知らせください。どうぞよろしくお願いいたします!"
        />
        <div className={styles.formBox}>
          <div className={styles.flexButton}>
            <button
              className={`${styles.personalButton} ${
                form === "personal" ? styles.active : ""
              }`}
