    ...
    <div className={styles.footer}>
      <div className={styles.container}>
            ...
            <ul>
              <li>
                <Link className={styles.list} href={"/about"}>
                  <p className={styles.listText}>About</p>
                  {/* <FaExternalLinkAlt className={styles.linkIcon} /> */}
                </Link>
              </li>
              <li>
                <Link className={styles.list} href={"/services"}>
                  <p className={styles.listText}>Services</p>
                  {/* <FaExternalLinkAlt className={styles.linkIcon} /> */}
                </Link>
              </li>
              <li>
                <Link className={styles.list} href={"/vision"}>
                  <p className={styles.listText}>Vision</p>
                  {/* <FaExternalLinkAlt className={styles.linkIcon} /> */}
                </Link>
              </li>
              <li>
                <Link className={styles.list} href={"/student"}>
                  <p className={styles.listText}>Student</p>
                  {/* <FaExternalLinkAlt className={styles.linkIcon} /> */}
                </Link>
              </li>
              <li>
                <Link className={styles.list} href={"/team"}>
                  <p className={styles.listText}>Team</p>
                  {/* <FaExternalLinkAlt className={styles.linkIcon} /> */}
                </Link>
              </li>
              <li>
                <Link className={styles.list} href={"/contact"}>
                  <p className={styles.listText}>Contact</p>
                  {/* <FaExternalLinkAlt className={styles.linkIcon} /> */}
                </Link>
              </li>
            </ul>
            {/* <Link className={styles.contactButton} href={"/contact"}>
              <p className={styles.contactButtonText}>話をする</p>
            </Link> */}
            <div className={styles.snsBox}>
              <ul>
                <li>
                  <Link
                    className={styles.snsLists}
                    href={"https://www.instagram.com/hokulea7311/?hl=ja"}
                  >
                ...
                <li>
                  <Link
                    className={styles.snsLists}
                    href={"https://twitter.com/Hokulea56362564"}
                  >
                ...
                <li>
                  <Link
                    className={styles.snsLists}
                    href={"https://www.tiktok.com/@hokulea7311"}
                  >
        ...
        <div className={styles.bottomBox}>
          <p className={styles.copyRight}>©︎2021 HOKULEA</p>
        </div>
      </div>
    </div>
  );
